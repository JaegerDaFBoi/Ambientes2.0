...
<div class="container-fluid">
  <div class="row">
    <x-adminlte-input name="environmentName" label="Nombre del Ambiente" fgroup-class="col-md-10" value="{{ $ambiente->nombre }}" />
  </div>
  <div class="row">
  ...
  <div class="row">
    <x-adminlte-input name="environmentCapacity" label="Capacidad" fgroup-class="col-md-6" value="{{ $ambiente->aforo }}" />
  </div>
  <div class="row">
    <div class="col-md-6">
